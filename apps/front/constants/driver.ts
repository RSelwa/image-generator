...
export const STEPS = {
  ...
  LOBBY_SPECIAL_ROUNDS: { element: `#${DRIVER_IDS.LOBBY_SPECIAL_ROUNDS}`, popover: { title: "Special rounds", description: "Specials rounds are every 6 normal rounds", side: "bottom", align: "center" } },
