...
export const NO_CARD_RARITY = "none"

export const CARD_RARITY_FILTER = {
  ALL: "all",
  NOT_RATED: "notRated",
} as const

export const CARD_RARITY_TO_BADGE_VARIANT = {
  [CARD_RARITY.COMMON]: BADGE_VARIANTS.NEUTRAL,
  [CARD_RARITY.UNCOMMON]: BADGE_VARIANTS.GREEN,
  [CARD_RARITY.RARE]: BADGE_VARIANTS.BLUE,
  [CARD_RARITY.ULTRA_RARE]: BADGE_VARIANTS.PURPLE,
  [CARD_RARITY.LEGENDARY]: BADGE_VARIANTS.YELLOW,
} as const
