...
export const SELECTORS = {
  ...
  ADMIN_MENU_CARDS: "admin-menu-cards",
  ADMIN_CARD_NEW: "admin-card-new",
  ADMIN_CARD_ROW: (cardId: string) => `admin-card-row-${cardId}`,
  CARD_FORM_TYPE: "card-form-type",
  CARD_FORM_TYPE_OPTION: (type: string) => `card-form-type-option-${type}`,
  CARD_FORM_GAME: "card-form-game",
  CARD_FORM_GAME_OPTION: (gameId: string) => `card-form-game-option-${gameId}`,
  CARD_FORM_MAP: "card-form-map",
  CARD_FORM_MAP_OPTION: (mapId: string) => `card-form-map-option-${mapId}`,
  CARD_FORM_RARITY: "card-form-rarity",
  CARD_FORM_RARITY_OPTION: (rarity: string) =>
    `card-form-rarity-option-${rarity}`,
  CARD_FORM_NUMBER: "card-form-number",
  ...
  GAME_FORM_CARD_RARITY: "game-form-card-rarity",
  GAME_FORM_CARD_RARITY_OPTION: (rarity: string) =>
    `game-form-card-rarity-option-${rarity}`,
  GAME_FORM_CARD_NUMBER: "game-form-card-number",
  GAME_FORM_SUBMIT: "game-form-submit",
  MAP_CARD: (mapId: string) => `map-card-${mapId}`,
  TRADING_CARD: (cardId: string) => `trading-card-${cardId}`,
  PACK_OPEN: "pack-open",
