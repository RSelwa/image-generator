...
const DeathRunWaiting = ({ deathRun }: { deathRun: DeathRunDocWithId }) => {
  ...
  return (
    <div
      className="relative h-full-height flex flex-col items-center justify-center gap-8 p-6 bg-repeat bg-center bg-size-[25%]"
    ...
    >
      ...
      <div className="w-full max-w-sm space-y-3">
        <div className="flex items-center gap-2 text-muted-foreground text-sm">
          ...
          <span>
            {deathRun.players.length} player
            {deathRun.players.length !== 1 ? "s" : ""}
          </span>
        </div>
        ...
        <Button
          ...
          onClick={() =>
            prepareAndStart({
              ...
              playersIds: deathRun.playersIds,
              lives: deathRun.lives,
            })
          }
        >
          {t("startGame")}
