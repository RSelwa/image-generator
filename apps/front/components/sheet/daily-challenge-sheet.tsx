...
import {
  ...
  updateDailyChallengeInputSchema,
} from "@repo/schemas"
...
const DailyChallengeForm = ({
  ...
  const [updateDailyChallenge, { isLoading }] =
    useUpdateDailyChallengeMutation()
        ...
        <FieldGroup>
          <Field>
            ...
            <Calendar
              mode="single"
              selected={
                watch("date") ? stringToDate(watch("date") || "") : undefined
              }
          ...
          <div className="flex justify-between items-start gap-8">
            ...
            {gameThumbnailUrl && (
              <Image
                ...
                width={100}
                height={56}
                className="mb-2 max-h-24 object-cover rounded"
              />
            )}
          </div>
          ...
          <Field>
            ...
            <Select
              value={difficulty}
              onValueChange={(val) =>
                setValue("difficulty", val as FormValues["difficulty"])
              }
            >
              <SelectTrigger>
      ...
      <SheetFooter>
        ...
        <AlertDialog>
          <AlertDialogTrigger asChild>
            <Button type="button" variant="marathon-destructive">
              Delete
            </Button>
          </AlertDialogTrigger>
          <AlertDialogContent>
...
export const DailyChallengeSheet = () => {
  ...
  const { data: challenge } = useGetDailyChallengeByDateQuery(
    { date: date || "" },
    { skip: !date },
  )
