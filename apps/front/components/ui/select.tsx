  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        "rounded-none font-mono bg-background",
        className,
      )}
      position={position}
      align={align}
...
const SelectLabel = ({
  ...
  <SelectPrimitive.Label
    ...
    className={cn("text-muted-foreground px-2 py-1.5 text-xs", "text-primary",className)}
    {...props}
  />
)
...
const SelectItem = ({
  ...
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      "rounded-none border-0 border-b border-foreground hover:border-primary focus:text-primary-foreground focus:bg-primary cursor-pointer",
      className,
    )}
    {...props}
  >
    ...
    <SelectPrimitive.ItemText className="font-mono uppercase">{children}</SelectPrimitive.ItemText>
  </SelectPrimitive.Item>
)
