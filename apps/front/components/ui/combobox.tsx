...
function ComboboxInput({
  ...
  return (
    <InputGroup className={cn("w-auto","rounded-none font-shapiro", className)}>
      <ComboboxPrimitive.Input
        render={<InputGroupInput disabled={disabled} />}
        {...props}
      />
      {(showTrigger || showClear)&&<InputGroupAddon align="inline-end">
        {showTrigger && (
          <InputGroupButton
            size="icon-xs"
            variant="ghost"
  ...
  return (
    <ComboboxPrimitive.Item
      ...
      className={cn(
        ...
        "data-highlighted:bg-primary data-highlighted:text-primary-foreground cursor-pointer rounded-none",
        className
      )}
      {...props}
    >
