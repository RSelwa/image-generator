...
const Page = () => {
  ...
  const isAllChecked = socials
    ? socials.length > 0 &&
      socials.every((social) => checkedIds.includes(social.id))
    : false
        ...
        <AlertDialog>
          ...
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                {" "}
                Are you sure you want to delete the selected socials? This
            ...
            <AlertDialogFooter>
              ...
              <AlertDialogAction variant="marathon-destructive" asChild>
                ...
                >
                  Yes, delete {checkedIds.length} social
        ...
        <Table noWrapper>
          ...
          <TableBody>
            {socials.map((social) => (
              <SocialRow
                key={social.id}
                {...{ social, setCheckedIds, checkedIds }}
              />
            ))}
          </TableBody>
        </Table>
