export const SOCIALS_HOOKS = {
  ...
  NOSTALGIA_EMOTION_1:
    "This game defined your personality. Do you remember it? ❤️",
  NOSTALGIA_EMOTION_2:
    "Nostalgia alert! Who pulled all-nighters playing this? 🌙",
  NOSTALGIA_EMOTION_3:
    "The atmosphere of this game is unmatched... recognizable anywhere.",
  NOSTALGIA_EMOTION_4:
    "POV: You just launched your favorite game in your childhood. 💿",

  CURIOSITY_DETAIL_1:
    "Look closely at the details... Does this world ring a bell? 👀",
